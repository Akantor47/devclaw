...
describe("E2E bootstrap — extraSystemPrompt injection", () => {
  ...
  it("should inject project-specific instructions via extraSystemPrompt", async () => {
    ...
    await dispatchTask({
      ...
      issueDescription: "",
      issueUrl: "https://example.com/work_items/1",
      role: "developer",
      level: "medior",
      fromLabel: "To Do",
      toLabel: "Doing",
  ...
  it("should fall back to default instructions when no project override exists", async () => {
    ...
    await dispatchTask({
      ...
      issueTitle: "Fix bug",
      issueDescription: "",
      issueUrl: "https://example.com/work_items/2",
      role: "developer",
      level: "junior",
      fromLabel: "To Do",
      toLabel: "Doing",
  ...
  it("should inject scaffolded default instructions when no overrides exist", async () => {
    ...
    await dispatchTask({
      ...
      issueTitle: "Chore",
      issueDescription: "",
      issueUrl: "https://example.com/work_items/3",
      role: "developer",
      level: "medior",
      fromLabel: "To Do",
      toLabel: "Doing",
  ...
  it("should resolve tester instructions independently from developer", async () => {
    ...
    await dispatchTask({
      ...
      issueDescription: "",
      issueUrl: "https://example.com/work_items/4",
      role: "tester",
      level: "medior",
      fromLabel: "To Test",
      toLabel: "Testing",
  ...
  it("should handle project names with hyphens correctly", async () => {
    ...
    await dispatchTask({
      ...
      issueDescription: "",
      issueUrl: "https://example.com/work_items/5",
      role: "developer",
      level: "senior",
      fromLabel: "To Do",
      toLabel: "Doing",
  ...
  it("should resolve architect instructions with project override", async () => {
    ...
    await dispatchTask({
      ...
      issueDescription: "",
      issueUrl: "https://example.com/work_items/6",
      role: "architect",
      level: "senior",
      fromLabel: "Planning",
      toLabel: "Planning",
