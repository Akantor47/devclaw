  ...
  describe("dispatchTask", () => {
    ...
    it("should transition label, update worker state, and fire gateway calls", async () => {
      const result = await dispatchTask({
        ...
        issueUrl: "https://example.com/work_items/42",
        role: "developer",
        level: "medior",
        fromLabel: "To Do",
        toLabel: "Doing",
    ...
    it("should set resolved model via sessions.patch, not agent RPC (#436)", async () => {
      ...
      const result = await dispatchTask({
        ...
        issueUrl: "https://example.com/work_items/99",
        role: "developer",
        level: "medior",
        fromLabel: "To Do",
        toLabel: "Doing",
  ...
  describe("full lifecycle", () => {
    it("developer:done → reviewer:approve → tester:pass (agent review path)", async () => {
      ...
      await dispatchTask({
        ...
        issueUrl: "https://example.com/work_items/100",
        role: "developer",
        level: "medior",
        fromLabel: "To Do",
        toLabel: "Doing",
    ...
    it("developer:done → human review pass → tester:pass (human review path)", async () => {
      ...
      await dispatchTask({
        ...
        issueUrl: "https://example.com/work_items/200",
        role: "developer",
        level: "senior",
        fromLabel: "To Do",
        toLabel: "Doing",
    ...
    it("developer:done → reviewer:reject → developer:done → reviewer:approve → tester:pass (reject cycle)", async () => {
      ...
      await dispatchTask({
        ...
        issueUrl: "https://example.com/work_items/300",
        role: "developer",
        level: "medior",
        fromLabel: "To Do",
        toLabel: "Doing",
  ...
  describe("role:level labels", () => {
    it("dispatch should apply role:level label to issue", async () => {
      ...
      await dispatchTask({
        ...
        issueDescription: "",
        issueUrl: "https://example.com/work_items/400",
        role: "developer",
        level: "senior",
        fromLabel: "To Do",
        toLabel: "Doing",
    ...
    it("dispatch should apply review:agent label for non-senior developer", async () => {
      ...
      await dispatchTask({
        ...
        issueDescription: "",
        issueUrl: "https://example.com/work_items/404",
        role: "developer",
        level: "junior",
        fromLabel: "To Do",
        toLabel: "Doing",
    ...
    it("dispatch should replace old role:level label", async () => {
      ...
      await dispatchTask({
        ...
        issueDescription: "",
        issueUrl: "https://example.com/work_items/401",
        role: "developer",
        level: "medior",
        fromLabel: "To Improve",
        toLabel: "Doing",
